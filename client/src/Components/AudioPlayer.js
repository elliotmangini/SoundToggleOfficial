...
export default function AudioPlayer({ user, playlist, setPlaylistToDisplay, setUser, fetchPlaylist, isEditing, setIsEditing }) {
  ...
  const handleExport = () => {
    const iframeCode = `<iframe src="http://localhost:4000/${playlist.user.username}/${convertToKebabCase(playlist.name)}/export" width="100%" height="800px" frameborder="0"></iframe>`;
